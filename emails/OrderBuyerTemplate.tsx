...
export default function OrderBuyerTemplate({ params: { options } }: Props) {
    return (
        <Html>
            <Section style={main}>
                <Container style={container}>
                    <Text style={heading}>Hello {options.buyer_name}</Text>
                    <Text style={bigtext}>You have placed new order with {options.seller_name}</Text>
                    ...
                    <Text style={paragraph}>Please wait for the sellers response by Phone or WhatsApp. You can contact the seller on the following numbers:</Text>
                    <Text style={paragraph}>Phone: {options.seller_phone}</Text>
                    <Text style={paragraph}>WhatsApp: {options.seller_whatsapp}</Text>
                    <Text style={paragraph}>----------------------------------------</Text>
