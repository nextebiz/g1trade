        ...
        <div className="container  px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64  flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <Link className="text-3xl flex justify-center sm:justify-start  font-bold font-heading " href="/">
              {/* eslint-disable */}
              <img className='' src='/images/logo/g1trade-logo-g1-garlic-sale-pakistan.svg?v-1' style={{ width: "150px" }} alt="G1 Garlic for Sale"  />
            </Link>
          ...
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div className="lg:w-1/3 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <li className='mb-2'>
                  <Link href='/help/buyer/how-to-buy-g1-garlic' className="hover:text-green-500">How To Place An Order</Link>
                </li>
                <li className='mb-2'>
                  <Link href='/help/seller/how-to-upload-new-product' className="hover:text-green-500">How To List Your G1 Garlic For Sale</Link>
                </li>
              </nav>
            </div>
            <div className="lg:w-1/3 md:w-1/2 w-full px-4">
