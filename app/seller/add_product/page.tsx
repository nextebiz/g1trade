...
export default function UploadNewProduct() {
  ...
  return (
    <div className='' style={{ width: "100%" }}>
      ...
      <div className='text-black py-4 md:py-6 pr-3 pl-4 md:pl-6  '>
                    ...
                    >
                      ...
                      >
                        ...
                        {provinces.map((province) => {
                          return (
                            <Select.Option key={province.id as string} value={`${province.id}`}>{province.name}</Select.Option>
                          )
                        })}
                      </Select>
                    </Form.Item>
                        ...
                        <div>
                          ...
                          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1'>
                            {selected_city_options.map(city => {
                              return (
                                <div key={city.id as string} className='border border-green-500 mb-2 p-2 pl-4 pr-4 rounded-full mr-2 flex justify-around items-center '>
                                  <CheckOutlined />
