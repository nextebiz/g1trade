  ...
  return (
    <div className='' style={{ width: "100%" }}>
      <div className='' style={{ width: "100%" }}>
        ...
        <div className='text-black bg-white pb-6' style={{ minHeight: "400px" }}>
          <section>
            {page_loaded ?
              ...
              <div >
                <div >
                  {user?.id === undefined ? <div>
                    ...
                    <div className='ml-3 mt-3  md:ml-6 md:mt-6 '>
                      <div className='mb-8'>
                      ...
                      <div className=''>
                        ...
                        >
                          ...
                          <div className='mb-8 pr-3' id="editor1">
