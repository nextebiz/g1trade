            ...
            <div>
              <div className='flex items-center flex-wrap'>
                <Link onClick={() => {
                  ...
                  <div className={`${order_action === "PENDING" ? "text-green-600 font-bold" : "text-blue-500"}   scale-100 hover:scale-110 transition-all`}>

                    Pending: {totals.PENDING}</div>
                </Link>
                <span className='px-1 md:px-3 text-sm text-slate-300'>|</span>
                <Link onClick={() => {
                  setOrderAction("ACCEPTED")
                }} href={'#'}>
                  <div className={`${order_action === "ACCEPTED" ? "text-green-600 font-bold" : "text-blue-500"}   scale-100 hover:scale-110 transition-all`}>

                    Accepted: {totals.ACCEPTED}</div>
                </Link>
                <span className='px-1 md:px-3 text-sm text-slate-300'>|</span>
                <Link onClick={() => {
                  setOrderAction("DELIVERED")
                }} href={'#'}>
                  <div className={`${order_action === "DELIVERED" ? "text-green-600 font-bold" : "text-blue-500"}   scale-100 hover:scale-110 transition-all`}>
                    Delivered: {totals.DELIVERED}</div>
                </Link>
                <span className='px-1 md:px-3 text-sm text-slate-300'>|</span>
                <Link onClick={() => {
                  setOrderAction("CANCELLED")
                }} href={'#'}>
                  <div className={`${order_action === "CANCELLED" ? "text-green-600 font-bold" : "text-blue-500"}   scale-100 hover:scale-110 transition-all`}>
                    Cancelled: {totals.CANCELLED}</div>
                </Link>
              </div>
              <div className='py-5'>
                <hr />
