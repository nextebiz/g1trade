  ...
  return (
    <div className='' style={{ width: "100%" }}>
      ...
      <div className='text-black  p-1'>
        <section>
          <div className="relative items-center w-full px-4 py-4 md:py-12 mx-auto md:px-12 lg:px-24 max-w-7xl">
            <div className="grid w-full grid-cols-1 gap-2 mx-auto md:grid-cols-1  lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-4">
