...
export default function SearchMenuLeft() {
    const openLeftPanelWidth = "300px"
    ...
    return (
        <div className='bg-white'>
            <div className='flex w-full clear-both '>
                <div
                    className='bg-slate-800 h-full transition-all relative hidden md:block'
                    style={{ width: leftPanelWidth, minHeight: "40px" }}>
