...
CREATE TABLE `WebsiteSettings` (
    `id` VARCHAR(191) NOT NULL,
    `facebook_login` BOOLEAN NULL DEFAULT true,
    `google_login` BOOLEAN NULL DEFAULT true,
    `twitter_login` BOOLEAN NULL DEFAULT true,
    `pinterest_login` BOOLEAN NULL DEFAULT true,
    `how_to_buy_video` VARCHAR(191) NULL DEFAULT 'https://www.youtube-nocookie.com/embed/yCDS6ZZYKwc',
    `how_to_sell_video` VARCHAR(191) NULL DEFAULT 'https://www.youtube-nocookie.com/embed/yCDS6ZZYKwc',
